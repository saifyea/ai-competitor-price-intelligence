...
"""with open(f"price_analysis.json", "w", encoding="utf-8") as f:
    json.dump(result, f, ensure_ascii=False, indent=2)

print(f"\n✅ Analysis saved to price_analysis.json")"""

# 1. Define your folder name
folder_name = "reports"

# 2. Automatically create the folder if it does not exist yet
os.makedirs(folder_name, exist_ok=True)

# 3. Combine the folder name and file name into a safe path
file_path = os.path.join(folder_name, "price_analysis.json")

# 4. Open and write to the file path
